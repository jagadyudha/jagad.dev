const Privacy = () => {
  return (
    <div className='prose prose-invert lg:prose-xl'>
      ...
      <p>
        Jagad Yudha built the CitizenApp as a Free app. This SERVICE is provided
        by Jagad Yudha at no cost and is intended for use as is.
      </p>{' '}
      <p>
      ...
      <p>
        ...
        Terms and Conditions, which are accessible at CitizenApp unless
      ...
      <p>This policy is effective as of 2026-06-10</p>{' '}
      <p>
        <strong>Contact Us</strong>
      </p>{' '}
      <p>
        If you have any questions or suggestions about my Privacy Policy, do not
        hesitate to contact me at jagadyudhaawali@umsida.ac.id.
      </p>{' '}
    </div>
  );
};
