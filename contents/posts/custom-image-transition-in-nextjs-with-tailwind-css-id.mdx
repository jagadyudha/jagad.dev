...
header: 'https://images.unsplash.com/photo-1518640467707-6811f4a6ab73?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=880&q=80'
date: '2022-05-12'
tags:
  - nextjs
  - tailwind
...
Untuk melihat cara kerja callback `onLoad Complete`, kita harus membuat state yang berisi boolean `false`.
...
```javascript
//ini adalah komponen gambar yang kita buat sebelumnya
