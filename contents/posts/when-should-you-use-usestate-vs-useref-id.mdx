...
<Image
  alt='React Hooks Meme'
  src='/jagad.dev/posts/when-should-you-use-usestate-vs-useref/react_hooks_meme_mgipd9.jpg'
  width='791'
  height='545'
/>

Sumber Gambar: [Сomics meme: "React dev Class components React hooks" - Comics - Meme-arsenal.com](https://www.meme-arsenal.com/en/create/meme/4667429)
...
Dalam contoh di atas, useState() mendeklarasikan variabel status sementara nilainya disimpan dalam variabel `nilai`. `setValue` adalah fungsi yang digunakan untuk memperbarui nilai ini. Setiap kali nilai input berubah, itu menyebabkan rendering ulang komponen.
...
Contoh lain, jika kita membuat toggle mode gelap, kita harus menggunakan useState karena state tersebut memengaruhi UI dan kita harus melakukan merender ulang.
