...
header: 'https://images.unsplash.com/photo-1559793978-37ab7dd23777?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=717&q=80'
date: '2021-07-17'
tags:
  - python
  - datamining
...
2. [Reading Data Using Python](#reading-data-using-python)
3. [Converting Data To Integer](#converting-data-to-integer)
4. [Checking training data](#checking-training-data)
5. [Determining Independent And Dependent Variables](#determining-independent-and-dependent-variables)
6. [Reading Testing Data](#reading-testing-data)
