...
header: 'https://images.unsplash.com/photo-1625805866449-3589fe3f71a3?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=687&q=80'
date: '2022-02-05'
tags:
  - nextjs
  - swr
...
<Image
  alt='Meme about Steam'
  src='/jagad.dev/posts/how-to-create-steam-player-summaries-with-next-js/Steam_Meme_mdaqaq.jpg'
  width='500'
  height='649'
/>
...
<Image
  alt='Demo'
  src='/jagad.dev/posts/how-to-create-steam-player-summaries-with-next-js/ezgif-4-45c79688ce_ry2iuz.gif'
  width='800'
  height='425'
/>

You can check live demo [here](/activities)
...
<Image
  alt='Steam Api key'
  src='/v1649551969/jagad.dev/posts/how-to-create-steam-player-summaries-with-next-js/steam_api_key_j8q6b7.png'
  width='877'
  height='265'
/>
...
<Image
  alt='Steam Id'
  src='/v1649552921/jagad.dev/posts/how-to-create-steam-player-summaries-with-next-js/steam_id_xtorcq.png'
  width='1470'
  height='233'
/>
...
Add `.env.local` file with key and id that we get before (change the data below with yours)
...
<Image
  alt='Response Api'
  src='/v1649553382/jagad.dev/posts/how-to-create-steam-player-summaries-with-next-js/Response_Api_yhi6p2.png'
  width='1077'
  height='277'
/>
