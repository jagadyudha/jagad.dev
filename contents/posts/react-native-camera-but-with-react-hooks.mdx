...
<img alt={React Native Camera} src={https://res.cloudinary.com/dlpb6j88q/image/upload/v1649557369/jagad.dev/posts/react-native-camera-but-with-react-hooks/RNCamera_nvliau.png} width={1919} height={1079} />
...
<img alt={Take Picture With RNCamera} src={https://res.cloudinary.com/dlpb6j88q/image/upload/v1649557743/jagad.dev/posts/react-native-camera-but-with-react-hooks/Take_picture_with_RNCamera_ursckf.png} width={1904} height={1080} />
...
<img alt={Scan Barcodes With RNCamera} src={https://res.cloudinary.com/dlpb6j88q/image/upload/v1649557941/jagad.dev/posts/react-native-camera-but-with-react-hooks/Scan_barcode_wirh_RNCamera_utwegr.png} width={1856} height={1078} />
